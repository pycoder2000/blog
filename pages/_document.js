    ...
    return (
      <Html lang="en" className="scroll-smooth">
        <Head>
          ...
          <meta
            name="description"
            content="Welcome to my blog! Here, you'll find my notes and thoughts on DataOps, as well as other interesting stuff. Thanks for stopping by and I hope you find something valuable..."
          />
