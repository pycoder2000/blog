...
draft: false
summary:  have tried several services that convert .tex file to PDF and then html, but the LaTeX diagrams and some of the Math’s equations and tables output is allover the place...
---

<img
  className="inline rounded-lg"
  src="/static/images/Blog/blog_post_3.jpg"
  alt="Spotify Logo"
/>
