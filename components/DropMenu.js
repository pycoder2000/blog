...
export default function DropMenu() {
  ...
  return (
    <Menu as="div" className="relative z-10 inline-block text-left ">
      <div>
        <Menu.Button className=" ml-2 cursor-pointer rounded-md bg-zinc-300 ring-neutral-400 hover:bg-zinc-300 hover:ring-2 dark:bg-zinc-700 dark:hover:bg-zinc-800">
          <motion.button
            ...
            <Menu.Item>
              {({ active }) => (
                <Link href="/quotes">
                  ...
                  >
                    <div className="flex flex-row">
                      <PilcrowIcon className="mr-4 mt-0.5" /> Quotes
                    </div>
                  </a>
                </Link>
              )}
